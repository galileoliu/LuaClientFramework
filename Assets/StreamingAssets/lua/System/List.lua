...
List_Node.__index = List_Node

function List_Node.New()
  local object = {}
  object.symbol = "List_Node"
  setmetatable(object, List_Node)
...
List_Iterator.__index = List_Iterator

function List_Iterator.New(_owner)
  local object = {}
  object.symbol = "List_Iterator"
  setmetatable(object, List_Iterator)
  object.owner = _owner
